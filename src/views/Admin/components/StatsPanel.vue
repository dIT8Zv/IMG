<template>
  <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
    <!-- 总图片数 -->
    <div class="group relative overflow-hidden bg-white border border-gray-200 rounded-xl p-5 hover:shadow-md transition-all duration-300">
    ...
    <div class="group relative overflow-hidden bg-white border border-gray-200 rounded-xl p-5 hover:shadow-md transition-all duration-300">
      <div class="flex items-center justify-between">
        <div>
          ...
          <p class="text-2xl font-bold text-gray-900">{{ timeAgo(stats.latestUpload) }}</p>
        </div>
        <div class="w-10 h-10 bg-gray-100 rounded-lg flex items-center justify-center group-hover:bg-gray-200 transition-colors">
          <svg class="w-5 h-5 text-gray-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
